...
* Unlike the Servo library this one does not come with the Arduino program so you will have to add it your self. You can download it from <a href="https://github.com/workshopweekend/many-ways-to-blink-4/raw/master/NewPing.zip">here</a>.
